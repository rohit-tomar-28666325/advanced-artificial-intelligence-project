...
class BayesNetInference(BayesNetReader):
    ...
    def __init__(self, alg_name, file_name, prob_query, num_samples, is_continuous=True):
        ...
        if is_continuous:
            ...
            prob_query = bnu.make_query_discrete(prob_query,continuous_columns,discretizer_file_path)
            print(prob_query)
